...
```
团队名称：投个屏小组
API Key：4c0193d1e908a598cfa6b5a0178371e8d8223ee28a426275d5be08c7c0a54ae3
```
...
X-API-Key: 4c0193d1e908a598cfa6b5a0178371e8d8223ee28a426275d5be08c7c0a54ae3
```
...
成功：
```json
{"success": true, "inserted": 1, "team": "投个屏小组"}
```
...
API_KEY = "4c0193d1e908a598cfa6b5a0178371e8d8223ee28a426275d5be08c7c0a54ae3"
...
print(r.json())  # {'success': True, 'inserted': 2, 'team': '投个屏小组'}
```
...
curl -X POST http://172.60.1.35:9621/api/external/report \
  ...
  -H "X-API-Key: 4c0193d1e908a598cfa6b5a0178371e8d8223ee28a426275d5be08c7c0a54ae3" \
...
Request request = new Request.Builder()
    ...
    .addHeader("X-API-Key", "4c0193d1e908a598cfa6b5a0178371e8d8223ee28a426275d5be08c7c0a54ae3")
